<template>
  <div class="main">
    ...
    <div v-if="isLoaded">
      ...
      />
      <ScrollNavi />
      <Chapter1 :items="articles_01" :class="isShowModal ? 'isModal' : ''" />
      <Chapter2 :items="articles_02" :class="isShowModal ? 'isModal' : ''" />
      <Chapter3 :items="articles_03" :class="isShowModal ? 'isModal' : ''" />
      <Footer />
    </div>
  </div>
</template>
...
<script>
  ...
  import { articles_01 } from "../assets/articles_01";
  import { articles_02 } from "../assets/articles_02";
  import { articles_03 } from "../assets/articles_03";
